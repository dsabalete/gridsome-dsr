    ...
    <div class="w-100">
      ...
      <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
        <div class="resume-content">
          ...
          <p>Frontend task with Vue.js in the YourDictionary.com team. Creation of new features, enforcing best practices and working in an agile environment in a decentralized international team.</p>
        </div>
      ...
      <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
        <div class="resume-content">
          <h3
            class="mb-0"
          >Senior Frontend Developer, Test Automation Engineer and Analyst Programmer</h3>
      ...
      <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
        <div class="resume-content">
          ...
          <p>Implementation of the "frontend" web for charging and contracting insurance applications in travel assistance and car insurance.</p>
        </div>
        <div class="resume-date text-md-right">
      ...
      <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
        <div class="resume-content">
          ...
          <p>In charge of maintaining the web portal of the organization (XML + XLS + Oracle with Cocoon) and other applications (with Struts).</p>
        </div>
        <div class="resume-date text-md-right">
      ...
      <div class="resume-item d-flex flex-column flex-md-row justify-content-between">
        <div class="resume-content">
          ...
          <p>Web development with ASP language, accessing a Microsoft SQL Server database with an intensive use of HTML and Javascript.</p>
        </div>
        <div class="resume-date text-md-right">
